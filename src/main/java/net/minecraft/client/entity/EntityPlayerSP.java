...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
            ...
            else
            {
                ...
                PostMotionUpdateEvent postMotionUpdateEvent = new PostMotionUpdateEvent();
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        PreMotionUpdateEvent preMotionUpdateEvent = new PreMotionUpdateEvent(this.rotationYaw, this.rotationPitch, this.onGround, this.posX, this.posY, this.posZ);
