...
public class GameSettings
{
    ...
    public static int exploitDPackets = 40;
    public static int exploitEPackets = 40;
    public static int exploitFPackets = 40;
    public static int crasherPackets = 400;
    public int clouds = 2;
    ...
    public KeyBinding CRASHER_MENU = new KeyBinding("AragostaMenu", Keyboard.KEY_RSHIFT, "key.categories.misc");
    ...
    public void setOptionFloatValue(GameSettings.Options settingsOption, float value) {
        ...
        if (settingsOption == GameSettings.Options.EXPLOITDPACKETS) {
            exploitDPackets =(int)value;
            if (exploitDPackets <= 0) {
                exploitDPackets = (int) GameSettings.Options.EXPLOITDPACKETS.getValueMax();
            }
        }

        if (settingsOption == GameSettings.Options.EXPLOITEPACKETS) {
            exploitEPackets =(int)value;
            if (exploitEPackets <= 0) {
                exploitEPackets = (int) GameSettings.Options.EXPLOITEPACKETS.getValueMax();
            }
        }

        if (settingsOption == GameSettings.Options.EXPLOITFPACKETS) {
            exploitFPackets =(int)value;
            if (exploitFPackets <= 0) {
                exploitFPackets = (int) GameSettings.Options.EXPLOITFPACKETS.getValueMax();
            }

        }

        if (settingsOption == Options.CRASHERPACKETS) {
            crasherPackets =(int)value;
            if (crasherPackets <= 0) {
                crasherPackets = (int) Options.CRASHERPACKETS.getValueMax();
            }
        }
    ...
    public float getOptionFloatValue(GameSettings.Options settingOption)
    {
        ...
        return f != Float.MAX_VALUE ? f : (settingOption == GameSettings.Options.FOV ? this.fovSetting :
                ...
                (settingOption == Options.EXPLOITDPACKETS ?  (float) exploitDPackets :
                (settingOption == Options.EXPLOITEPACKETS ?  (float) exploitEPackets :
                (settingOption == Options.EXPLOITFPACKETS ?  (float) exploitFPackets :
                (settingOption == Options.CRASHERPACKETS ?  (float)crasherPackets :
                (settingOption == GameSettings.Options.MIPMAP_LEVELS ? (float)this.mipmapLevels
                 : (settingOption == GameSettings.Options.RENDER_DISTANCE ? (float)this.renderDistanceChunks
                        : (settingOption == GameSettings.Options.STREAM_BYTES_PER_PIXEL ? this.streamBytesPerPixel
                        : (settingOption == GameSettings.Options.STREAM_VOLUME_MIC ? this.streamMicVolume
                        : (settingOption == GameSettings.Options.STREAM_VOLUME_SYSTEM ? this.streamGameVolume
                        : (settingOption == GameSettings.Options.STREAM_KBPS ? this.streamKbps
                        : (settingOption == GameSettings.Options.STREAM_FPS ? this.streamFps : 0.0F)))))))))))))))))))));
    }
    ...
    public String getKeyBinding(GameSettings.Options settingOption)
    {
        ...
        else
        {
            ...
            if (settingOption.getEnumFloat())
            {
                ...
                return settingOption == GameSettings.Options.MIPMAP_LEVELS && (double)f1 >= 4.0D ? s1 + Lang.get("of.general.max") : (settingOption == GameSettings.Options.SENSITIVITY ? (f == 0.0F ? s1 + I18n.format("options.sensitivity.min", new Object[0]) : (f == 1.0F ? s1 + I18n.format("options.sensitivity.max", new Object[0]) : s1 + (int)(f * 200.0F) + "%")) : (settingOption == GameSettings.Options.FOV ? (f1 == 70.0F ? s1 + I18n.format("options.fov.min", new Object[0]) : (f1 == 110.0F ? s1 + I18n.format("options.fov.max", new Object[0]) : s1 + (int)f1))
                        ...
                        //Aragosta
                        : (settingOption == Options.EXPLOITDPACKETS ? (f1 == settingOption.valueMax ? s1 + I18n.format("500", new Object[0])
                        : s1 + (int)f1 + "")
                        : (settingOption == Options.EXPLOITEPACKETS ? (f1 == settingOption.valueMax ? s1 + I18n.format("500", new Object[0])
                        : s1 + (int)f1 + "")
                        : (settingOption == Options.EXPLOITFPACKETS ? (f1 == settingOption.valueMax ? s1 + I18n.format("500", new Object[0])
                        : s1 + (int)f1 + "")


                        : (settingOption == Options.CRASHERPACKETS ? (f1 == settingOption.valueMax ? s1 + I18n.format("1000", new Object[0])
                        : s1 + (int)f1 + "")
                    ...
                    : (settingOption == GameSettings.Options.RENDER_CLOUDS ? (f1 == settingOption.valueMin ? s1 + I18n.format("options.cloudHeight.min", new Object[0])
                        ...
                        : (settingOption == GameSettings.Options.MIPMAP_LEVELS ? (f1 == 0.0F ? s1 + I18n.format("options.off", new Object[0])
                        ...
                        : (settingOption == GameSettings.Options.STREAM_BYTES_PER_PIXEL ? s1 + String.format("%.3f bpp", new Object[] {Float.valueOf(TwitchStream.formatStreamBps(f))})
    ...
    public static enum Options
    {
        ...
        EXPLOITDPACKETS("ExploitD packets", true, false, 40.0F, 500.0F, 5.0F),
        EXPLOITEPACKETS("ExploitE packets", true, false, 40.0F, 500.0F, 5.0F),
        EXPLOITFPACKETS("ExploitF packets", true, false, 40.0F, 500.0F, 5.0F),
        CRASHERPACKETS("Crashers packets", true, false, 40.0F, 1000.0F, 5.0F),
