...
import it.thatskai.aragosta.gui.mainmenu.GuiClientMainMenu;
import it.thatskai.aragosta.gui.hook.GuiClientInGame;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new GuiMultiplayer(), this, this.serverName, this.serverPort));
        ...
        try {
            AragostaMain.getClient().clientStart();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        if (guiScreenIn == null && this.theWorld == null)
        {
            ...
            guiScreenIn = new GuiMultiplayer();
        }
