...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(39, this.width / 2 - 100, this.height / 4 + 56, 98, 20, I18n.format("MultiPlayer menu", new Object[0])));
        GuiButton guibutton;
        ...
        switch (button.id)
        {
            ...
            case 1:
                ...
                else if (flag1)
                {
                    ...
                    realmsbridge.switchToRealms(new GuiMultiplayer());
                }
                else
                {
