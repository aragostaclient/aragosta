...
import it.thatskai.aragosta.gui.GuiUUIDSpoof;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(new GuiButton(6,this.width / 2 - 234, this.height - 28, 70, 20, "UUID Spoof"));

        this.buttonList.add(new GuiButton(15, 10, 100, 200, 20, I18n.format("menu.singleplayer", new Object[0])));

        //extras
        this.buttonList.add(new GuiButton(254,10, 130, 200, 20, "Accounts"));
        this.buttonList.add(new GuiButton(123,10, 160, 200, 20, "Versions"));

        this.buttonList.add(new GuiButton(23,10, 190, 200, 20, "Settings"));
        this.buttonList.add(new GuiButton(1235,10, 220, 200, 20, I18n.format("menu.quit")));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled)
        {
            ...
            else if (button.id == 8)
            {
                ...
                mc.displayGuiScreen(new GuiUUIDSpoof(this));
            }
        }
    }
