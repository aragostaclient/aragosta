...
public class EventManager {
    ...
    private final Map<Class<? extends Event>, ArrayHelper<EventData>> REGISTRY_MAP = new HashMap<>();
    ...
    public void cleanMap(boolean b) {
        ...
        Iterator<Map.Entry<Class<? extends Event>, ArrayHelper<EventData>>> iterator = REGISTRY_MAP.entrySet().iterator();
